...
pair<Coordinates, Coordinates> findClosestPairOfPoints(vector<Coordinates>& points, int left, int right) {
    ...
    return ( calculateDistanceBetweenPoints(closestRight.first, closestRight.second) >= calculateDistanceBetweenPoints(closestLeft.first, closestLeft.second) ) ?
...
int main() {
    ...
    cout << "Closest points: (" << closestPoints.first.a << ", " << closestPoints.first.b << ") and ("
        << closestPoints.second.a << ", " << closestPoints.second.b << ")\n";
